...
Decisions and scope agreed on 2026-07-10. This document is the record of _why_;
...
> _eliminated_ by the web (link → voting in seconds, any phone), and the
...
- Anonymous / majority / unanimous voting modes (scoring _is_ the mode)
...
- **❤️ Favorite** is _in_ the MVP (cheap, feeds tiebreaks) but is the first thing cut if the voting UX gets muddy.
